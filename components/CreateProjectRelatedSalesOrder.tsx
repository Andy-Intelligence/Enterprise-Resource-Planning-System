...
const CreateProjectRelatedSalesOrder = () => {
    ...
    <table className="w-full border-collapse border border-gray-200 mt-4">
      <thead>
        <tr className="bg-gray-100">
          ...
          <th className="border border-gray-200 px-4 py-2">Sales Person</th>
          <th className="border border-gray-200 px-4 py-2">Total</th>
          <th className="border border-gray-200 px-4 py-2">Invoice Status</th>
...
export default CreateProjectRelatedSalesOrder;
