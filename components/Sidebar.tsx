...
const Sidebar = ({ isExpanded, onToggle }: SidebarProps) => {
  ...
  return (
    <motion.aside
      className="fixed top-0 left-0 min-h-screen bg-gradient-to-b from-blue-600 to-blue-700 text-white overflow-hidden transition-all duration-300 ease-in-out"
      variants={sidebarVariants}
      animate={isExpanded ? "expanded" : "collapsed"}
    >
      <div className="p-4">
